...
void initQueuesAndEvents() {
  ...
  configASSERT(g_scale_sample_q && g_display_mailbox && g_button_edge_q &&
               g_button_press_q && g_telemetry_q && g_dose_request_q &&
               g_settings_mailbox_scale && g_settings_mailbox_dosing &&
               g_settings_mailbox_input && g_settings_mailbox_network &&
               g_settings_write_q && g_topup_model_mailbox &&
               g_persist_request_q && g_ws_broadcast_q && g_sys_events);
}
